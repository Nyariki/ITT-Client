package com.itt.client.view.main.clock;
...
public abstract class VectorAnalogClock extends RelativeLayout {
    ...
    private AppCompatImageView analogLabel;
    ...
    public void initializeSimple() {
        ...
        this.labelId = R.drawable.clock_labels;
     ...
     */
    public void initializeCustom(@DrawableRes int faceId, @DrawableRes int labelId, @DrawableRes int hourId, @DrawableRes int minuteId, @DrawableRes int secondId) {
        this.faceId = faceId;
    ...
    private int faceColor = 0xff000000;
     ...
     * @param color: hexadecimal color (ex: 0xff000000)
     */
    public VectorAnalogClock setFaceColor(int color) {
        this.faceColor = color;
        main(ctx);
     ...
     * @param color: hexadecimal color (ex: 0xff000000)
     */
    public VectorAnalogClock setLabelColor(int color) {
        this.labelColor = color;
        main(ctx);
    ...
    private void main(Context ctx) {
        ...
        Drawable label = AppCompatResources.getDrawable(ctx, labelId);
        ...
        label.setAlpha(alpha255);
        hour.setAlpha(alpha255);
        minute.setAlpha(alpha255);
        second.setAlpha(alpha255);

        face = DrawableCompat.wrap(face);
        label = DrawableCompat.wrap(label);
        hour = DrawableCompat.wrap(hour);
        minute = DrawableCompat.wrap(minute);
        second = DrawableCompat.wrap(second);

        DrawableCompat.setTint(face.mutate(), faceColor);
        DrawableCompat.setTint(label.mutate(), labelColor);
        DrawableCompat.setTint(hour.mutate(), faceColor);
        DrawableCompat.setTint(minute.mutate(), faceColor);
        DrawableCompat.setTint(second.mutate(), faceColor);

        inflate(ctx, R.layout.analog_clock, this);

        analogFace = findViewById(R.id.face);
        analogLabel = findViewById(R.id.label);
        ...
        analogLabel.setAdjustViewBounds(true);
        ...
        analogLabel.setLayoutParams(layoutParams);
        ...
        analogLabel.setImageDrawable(label);
     ...
     * Stop Clock
     */
    public void stopTickTick() {
        setPositionFor(analogSecond);
        setPositionFor(analogMinute);
        setPositionFor(analogHour);
        try {
            analogSecond.clearAnimation();
            analogMinute.clearAnimation();
            analogHour.clearAnimation();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
